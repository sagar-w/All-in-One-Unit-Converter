...
def CurrencyConverter():
    ...
    titleLabel = Label (mainframe, text = "Currency Converter", font = ("times new roman", 12, "bold"), justify = CENTER).grid(column=1,row=1)
    in_amt = StringVar()
    in_amt.set('0')
    out_amt = StringVar()
...
def WeightConverter():
    ...
    mainframe = ttk.Frame(root, padding="3 3 12 12")
    mainframe.pack(fill=BOTH, expand=1)
    titleLabel = Label (mainframe, text = "Weight Converter", font = ("times new roman", 12, "bold"), justify = CENTER).grid(column=1,row=1)
...
def AreaConverter():
    ...
    titleLabel = Label (wind, text = "Area Converter", font = ("times new roman", 12, "bold"), justify = CENTER).grid(column=1,row=1)
    ...
    toLabel = Label(wind, text="To : ", font="times new roman").grid(row=2, column = 2)  
...
def LengthConverter():
    ...
    mainframe = ttk.Frame(root, padding="3 3 12 12")
    mainframe.pack(fill=BOTH, expand=1)
    titleLabel = Label (mainframe, text = "Length Converter", font = ("times new roman", 12, "bold"), justify = CENTER).grid(column=1,row=1)
